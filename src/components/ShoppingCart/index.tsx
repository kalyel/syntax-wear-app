      ...
      >
        ...
        >
                ...
                <li key={product.id} className="flex flex-col gap-1 px-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <div className="flex border gap-6 py-1 px-3">
          ...
          <footer className="absolute bottom-0 w-full h-[100px] p-4">
            <button className="w-full h-full bg-black text-white rounded-xs cursor-pointer hover:bg-gray-800 transition">Fechar pedido</button>
          </footer>
        </div>
      </div>
    </>
