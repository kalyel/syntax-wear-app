...
function RouteComponent() {
  ...
  return (
    <section className="container pt-44 md:pt-54 pb-10 md:px10 mb-10 text-black min-h-[80vh] flex flex-col justify-center items-center">
      ...
      {filteredProducts.length === 0 ? (
        <>
          <p className="text-center mb-6">Nenhum produto encontrado</p>
          <Link
            to="/products"
