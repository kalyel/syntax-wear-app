...
export const Route = createFileRoute("/_app/products/$productId")({
  ...
  head: ({ params }) => {
    ...
    const title = filteredProduct
      ...
      : "Prouto nao encontrado - Produtos - SyntaxWear";
  ...
  if (!filteredProduct)
    return (
      <section className="container mb-10 pt-44 md:pt-54 pb-10 md:px-10 text-center text-black min-h-[80vh] flex flex-col justify-center items-center">
        <h1 className="text-3xl font-bold mb-4">Prouto não encontrado</h1>
        <p className="mb-6">
          O produto que você esta procurando não existe ou foi removido
        </p>
        <Link
          to="/products"
