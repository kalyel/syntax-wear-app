...
import OurStoresBanner from "@/assets/images/banners/banner-our-stores.png";
import OurStoresImg1 from "@/assets/images/banners/loja-1.png";
import OurStoresImg2 from "@/assets/images/banners/loja-2.png";
      ...
      <div>
        ...
        <section className="text-black w-full space-y-20">
          <div className=" flex flex-col md:flex-row items-center gap-2.5">
            ...
            <img src={OurStoresImg1} alt="Imagem de um tênis da loja" className="rounded-[20px] md:max-w-[42vw] aspect-10/7 obejct-cover size-full"/>
          </div>
